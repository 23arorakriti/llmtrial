...
pdfpath = ["cancer-myths-and-facts.pdf", "skin-cancer-myths.pdf"]
urls = [
    ...
    "https://www.cancercenter.com/community/blog/2019/02/11-cancer-myths-busted",
